...
Feature: Configuring the theme_boost_union plugin for the "Calendar branding" tab on the "Look" page
  ...
  Scenario: Setting: Calendar event colors - Setting the color for event type category
    Given the following config values are set as admin:
      | config                           | value   | plugin            |
      | calendareventcategorycolor       | #ffc8ff | theme_boost_union |
      | calendareventcategorybordercolor | #ff00ff | theme_boost_union |
  ...
  Scenario: Setting: Calendar event colors - Setting the color for event type course
    Given the following config values are set as admin:
      | config                         | value   | plugin            |
      | calendareventcoursecolor       | #ffc8ff | theme_boost_union |
      | calendareventcoursebordercolor | #ff00ff | theme_boost_union |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I create a calendar event with form data:
  ...
  Scenario: Setting: Calendar event colors - Setting the color for event type site
    Given the following config values are set as admin:
      | config                       | value   | plugin            |
      | calendareventsitecolor       | #ffc8ff | theme_boost_union |
      | calendareventsitebordercolor | #ff00ff | theme_boost_union |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I create a calendar event with form data:
      | Type of event | Site       |
  ...
  Scenario: Setting: Calendar event colors - Setting the color for event type group
    Given the following config values are set as admin:
      | config                        | value   | plugin            |
      | calendareventgroupcolor       | #ffc8ff | theme_boost_union |
      | calendareventgroupbordercolor | #ff00ff | theme_boost_union |
    And the theme cache is purged and the theme is reloaded
  ...
  Scenario: Setting: Calendar event colors - Setting the color for event type user
    Given the following config values are set as admin:
      | config                       | value   | plugin            |
      | calendareventusercolor       | #ffc8ff | theme_boost_union |
      | calendareventuserbordercolor | #ff00ff | theme_boost_union |
    And the theme cache is purged and the theme is reloaded
    When I log in as "admin"
    And I create a calendar event with form data:
      | Type of event | User       |
  ...
  @javascript
  Scenario: Setting: Calendar event colors - Setting the color for hide/show filter icons, edit/delete button icons
    Given the following config values are set as admin:
      | config             | value   | plugin            |
